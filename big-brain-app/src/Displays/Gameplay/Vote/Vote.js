                    ...
                    >
                        ...
                        >
                            {voteResults[player.stats.index] &&
                                voteResults[player.stats.index].map(
                                    (idx, i) => (
                                        <span key={i}>
                                            <img
                                                src={`/icons/${idx}.svg`}
                    ...
                    >
                        ...
                        <Box mt={2}>
                            ...
                            >
                                ...
                                >
                                    {voteResults[voteResults.length - 1] &&
                                        voteResults[voteResults.length - 1].map(
                                            (idx, i) => (
                                                <span key={i}>
                                                    <img
                                                        src={`/icons/${idx}.svg`}
